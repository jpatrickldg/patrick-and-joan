  ...
  return (
    <section id="hero" className="hero-section relative min-h-screen w-full">
      ...
      <div className="absolute inset-0 h-full flex flex-col items-center text-white">
        {/* NAVBAR */}
        {/* <Navbar /> */}
        <div className="flex-1 text-base flex flex-col items-center 5xl:justify-center mt-20 md:mt-40 5xl:mt-0 gap-4 xl:text-xl">
          <p>We are getting married</p>
          <h1 className="text-4xl lg:text-6xl 2xl:text-8xl font-bold font-libre">
            Patrick & Joan
          </h1>
